...
class Aplicacion:
    def __init__(self):
        ...
        opciones1.add_command(
            label="Rojo", command=self.fijarrojo, accelerator="Ctrl+R")
        opciones1.add_command(
            label="Verde", command=self.fijarverde, accelerator="Ctrl+V")
        opciones1.add_separator()
        opciones1.add_command(
            label="Azul", command=self.fijarazul, accelerator="Ctrl+A")
